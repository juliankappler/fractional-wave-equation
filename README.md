...
Here is a simple example (the corresponding jupyter notebook can be found here):
...
Here is a 2D plot of the solution <i>U(x,t)</i> generated by the above code (as given in this example):
